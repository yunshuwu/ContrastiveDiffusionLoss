...
class WrapModel(Model):
    ...
    def forward(self, x, logsnr):
        ...
        eps_hat = super().forward(x, timestep)
        return eps_hat
    ...
    def logsnr2t(self, logsnr):
        ...
        timestep = torch.argmin(abs(alphabarGT-alphas_cumprod.unsqueeze(1)), dim=1) * scale # bring the timestep back to the original range [0,T]
        return timestep